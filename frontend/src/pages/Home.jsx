...
export default function Home() {
    ...
    return (
        <div>
            ...
            <section className="bg-grid z-1">
                <div className="flex flex-col md:flex-row items-center justify-between text-center gap-4 md:gap-6 px-4 md:px-0 py-12 mt-[10vh]">
                    <div className="flex flex-col font-serif gap-6 items-center md:items-start font-bold text-center md:text-left max-w-md text-base md:text-lg">
                        <h2 className="font-serif text-center md:text-left font-bold text-5xl md:text-6xl lg:text-7xl text-main">Find <br /> <span className="text-secondary">community made</span> <br /> <span className="text-primary">quizzes</span></h2>
                        <p className="text-secondary">
                            In vulputate cursus sem ac consectetur. Nam nec ex scelerisque, blandit neque sit amet.
                        </p>
                    </div>
            ...
            <section className="bg-grid z-1">
                <div className="flex flex-col md:flex-row items-center justify-between text-center gap-4 md:gap-6 px-4 md:px-0 py-12 mt-[10vh]">
                    <img src="/src/assets/images/hero_section_2.png" alt="Picture of quiz creation process" className="md:w-1/3 w-3/4 py-4 px-20 rounded-2xl bg-primary" />
                    <div className="flex flex-col font-serif gap-6 items-center md:items-end font-bold text-center md:text-right max-w-md text-base md:text-lg">
                        <h2 className="font-serif text-center md:text-right font-bold text-5xl md:text-6xl lg:text-7xl text-main">Create <br /> <span className="text-secondary">your own</span> <br /> <span className="text-primary">quizzes</span></h2>
                        <Button onClick={() => navigate("/login?register=true")} className="py-5 px-10 text-lg md:py-6 md:px-12 md:text-2xl">Register Now</Button>
                        <p className="text-secondary">
