    ...
    return (
        <div className="flex flex-col items-center md:items-start gap-4 md:gap-6 px-4 md:px-0 py-12 mt-[10vh]">
            ...
            <div className="flex flex-col items-center md:items-start">
                <p className="text-secondary text-center md:text-left font-medium max-w-md text-base md:text-lg">
                    In vulputate cursus sem ac consectetur. Nam nec ex scelerisque, blandit neque sit amet.
                </p>
                <p className="text-gray-500 text-center md:text-left font-medium max-w-md text-base md:text-lg">
