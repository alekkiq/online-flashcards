...
export default function Classrooms() {
    ...
    const { searchQuery, setSearchQuery, filteredClassrooms } = useClassroomSearch(searchParams, setSearchParams, selectedSubject);
    ...
    return (
        <div className="max-w-5xl mx-auto py-8 space-y-6 md:space-y-8">
            <div className="mt-8">
                <div className="mb-6">
                    <h1 className="font-serif text-4xl md:text-5xl font-bold text-main mb-2">My Classrooms</h1>
                ...
                <div className="flex flex-col gap-4 sm:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    ...
                    {!isTeacher && (
                        <NewItemCard
                            ...
                            icon={<DoorOpen className="w-12 h-12 text-gray-400 group-hover:text-gray-600 transition-colors" />}
                        />
                    )}
