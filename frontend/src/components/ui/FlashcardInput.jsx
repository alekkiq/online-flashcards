  ...
  return (
    <div className="flex gap-4 py-6 border-b border-primary/20 last:border-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1">
        <FormField label={t("flashcardInput.question")} error={questionError}>
          <textarea
            ...
            placeholder={t("flashcardInput.questionPlaceholder")}
          />
        </FormField>

        <FormField label={t("flashcardInput.answer")} error={answerError}>
          <textarea
            ...
            placeholder={t("flashcardInput.answerPlaceholder")}
          />
        </FormField>
      </div>
